...
const Header = (props) => {
    ...
    return (
        <div className="flex items-center justify-between py-4 gap-5">
            <Link href="/" className="text-xl font-bold">Hemant Singh Rajawat </Link>
            <Link href="/Suggestions" className='text-lgfont-medium'>Some Important Suggestions </Link>
            <Link href="/CryptoPayments" className='text-lgfont-medium'>CryptoPayments</Link>
