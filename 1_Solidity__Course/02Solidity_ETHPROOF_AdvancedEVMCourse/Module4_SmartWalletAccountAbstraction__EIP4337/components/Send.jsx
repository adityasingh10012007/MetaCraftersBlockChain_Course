...
function Send({ config, init }) {
    ...
    return (
        <div className=''>
            {!popUp ? (
                <button className='bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-lg' onClick={togglePopUp}>Send</button>
            ) : (
                <div className='fixed top-0 lg:m-0  left-0 right-0 bottom-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50'>
                    <div className='bg-black w-full sm:max-w-md rounded-lg overflow-hidden shadow-xl lg:mx-0 mx-5'>
                        <div className='p-4'>
                            <div className='flex items-center justify-between'>
                                <h2 className='text-2xl text-white   font-bold mb-4'>Send your Funds    </h2>
                            ...
                            {transactionHash
                                ...
                                <form>
                                    <div className='mb-4'>
                                        <label className='block font-bold mb-2  text-blue-500   ' htmlFor='send-address'>
                                            Address
                                        </label>
                                        <input
                                    ...
                                    <div className='mb-4'>
                                        <label className='block font-bold mb-2   text-blue-500   ' htmlFor='amount'>
                                            Amount
                                        </label>
                                        <input
                                            className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:border-blue-500'
